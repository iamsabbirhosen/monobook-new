...
const AppProvider = ({ children })=>{
    ...
    const [readPages, setReadPages] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    const addBookToLibrary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[addBookToLibrary]": (bookId)=>{
            setLibrary({
                "AppProvider.useCallback[addBookToLibrary]": (prev)=>prev.includes(bookId) ? prev : [
                        ...prev,
                        bookId
                    ]
            }["AppProvider.useCallback[addBookToLibrary]"]);
        }
    }["AppProvider.useCallback[addBookToLibrary]"], []);
    const isBookInLibrary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[isBookInLibrary]": (bookId)=>library.includes(bookId)
    }["AppProvider.useCallback[isBookInLibrary]"], [
        library
    ]);
    const updateNote = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[updateNote]": (bookId, page, content)=>{
            setNotes({
                "AppProvider.useCallback[updateNote]": (prev)=>({
                        ...prev,
                        [bookId]: {
                            ...prev[bookId],
                            [page]: content
            ...
            }["AppProvider.useCallback[updateNote]"]);
        }
    }["AppProvider.useCallback[updateNote]"], []);
    const getNote = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[getNote]": (bookId, page)=>{
            return notes[bookId]?.[page] || '';
        }
    }["AppProvider.useCallback[getNote]"], [
        notes
    ]);
    const logReadingTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[logReadingTime]": (seconds)=>{
            setStats({
                "AppProvider.useCallback[logReadingTime]": (prev)=>({
                        ...prev,
                        totalTimeSeconds: prev.totalTimeSeconds + seconds
                    })
            }["AppProvider.useCallback[logReadingTime]"]);
        }
    }["AppProvider.useCallback[logReadingTime]"], []);
    const getPagesReadCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[getPagesReadCount]": ()=>{
            return Object.values(readPages).reduce({
                "AppProvider.useCallback[getPagesReadCount]": (acc, bookPages)=>acc + bookPages.size
            }["AppProvider.useCallback[getPagesReadCount]"], 0);
        }
    }["AppProvider.useCallback[getPagesReadCount]"], [
        readPages
    ]);
    const logPageRead = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[logPageRead]": (bookId, page)=>{
            setReadPages({
                "AppProvider.useCallback[logPageRead]": (prev)=>{
                    const newReadPages = {
                        ...prev
                    };
            ...
            }["AppProvider.useCallback[logPageRead]"]);
        }
    }["AppProvider.useCallback[logPageRead]"], []);
    const getNotesTakenCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[getNotesTakenCount]": ()=>{
            return Object.values(notes).reduce({
                "AppProvider.useCallback[getNotesTakenCount]": (total, bookNotes)=>{
                    return total + Object.values(bookNotes).filter({
                        "AppProvider.useCallback[getNotesTakenCount]": (note)=>note.trim() !== ''
                    }["AppProvider.useCallback[getNotesTakenCount]"]).length;
                }
            }["AppProvider.useCallback[getNotesTakenCount]"], 0);
        }
    }["AppProvider.useCallback[getNotesTakenCount]"], [
        notes
    ]);
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "hidden font-bold sm:inline-block font-headline text-lg tracking-wider",
...
//# sourceMappingURL=src_fbea6fed._.js.map